...
| 设计健康规则 | 十一份规范已落地：ui-foundation / reuse-rules / extension-rules / pluginization / testing / runtime-health / security / build-release / product-quality / coding-standards / TERMINOLOGY（M6–M14 登记）+ `CONTRIBUTING.md`；机检状态逐条诚实标注 |
| 更新时间 | 2026-08-20 |
