...
> 以下为真实运行环境实机截图（Windows 11 · 2558×1436）。

**桌面总览** —— 桌面图标、任务栏与自绘桌面并存

<p align="center">
  <img src="docs/screenshots/01-desktop-overview.jpg" alt="桌面总览" width="72%">
</p>

**右键菜单体系** —— 桌面右键菜单与「桌面控制」子菜单；右键扩展项（Git Bash / MobaXterm / 桌面控制…）深度集成原生菜单

<p align="center">
  <img src="docs/screenshots/03-context-menu-control.jpg" alt="桌面右键菜单与桌面控制子菜单" width="49%">
  <img src="docs/screenshots/06-context-menu-extended.jpg" alt="原生右键菜单扩展" width="49%">
</p>

**常驻面板** —— 剪贴板历史（搜索 / 标签筛选 / 一键复制）与全局热键侧板；Rust core 托盘菜单（组件按需拉起、诊断、更新、应急恢复）

<p align="center">
  <img src="docs/screenshots/02-clipboard-history.jpg" alt="剪贴板历史与热键侧板" width="49%">
  <img src="docs/screenshots/04-tray-menu.jpg" alt="BetterDesktop Core 托盘菜单" width="49%">
</p>

**设置中心** —— 应用来源 / Dock 固定项 / 主题 / 热键 / 任务栏外观 / 开始菜单 / 右键菜单 / 剪贴板 / 灵动岛 / 实时翻译，一站式配置

<p align="center">
  <img src="docs/screenshots/05-settings-app-sources.jpg" alt="设置中心 · 应用来源" width="72%">
</p>
