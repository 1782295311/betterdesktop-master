...
function Step([string]$message) { Write-Host "[uninstall] $message" -ForegroundColor Cyan }
function Warn([string]$message) { Write-Host "[uninstall][warn] $message" -ForegroundColor Yellow }
