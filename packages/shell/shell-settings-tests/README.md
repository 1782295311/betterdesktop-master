# BetterDesktop.Shell.Settings.Tests

## 测试范围

设置服务：键值存储、热更新事件、默认值回退、设置目录枚举。

## 运行方式

```bash
# 单工程
dotnet test packages/shell/shell-settings-tests/BetterDesktop.Shell.Settings.Tests.csproj
