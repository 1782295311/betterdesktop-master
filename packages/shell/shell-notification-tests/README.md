# BetterDesktop.Shell.Notification.Tests

## 测试范围

通知中心：Toast 转发、通知持久化、已读/清除状态。

## 运行方式

```bash
# 单工程
dotnet test packages/shell/shell-notification-tests/BetterDesktop.Shell.Notification.Tests.csproj
